...
const storeEthTransactions = ({ number, data }) =>
  Promise.all(data.addresses.map(function (addr) {
    ...
    return Promise.all([
      ...
      pg_db.none('insert into transactions ("from", "to", hash, block_hash, block_number, gas, gas_price, index, nonce) values ($1, $2, $3, $4, $5, $6, $7, $8, $9) ON CONFLICT (hash) DO NOTHING;',
